...
In the workspace documentation store, apply this skill to document sections, record bodies, and term definitions. Generated regions (`<!-- docs:generated:* -->`) are derived; do not edit or rewrite them. Code, identifiers, and directive metadata keep their exact form.
